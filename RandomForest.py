...
def main():
	...
	hyper_params.append((100, 'entropy', 10, 0.001))
	# hyper_params.append((500, 'entropy', 10, 0.01))
...
def createModel(hyper_params, train_dataset, train_labels, test_dataset, test_labels):
	n_estimators = hyper_params[0]
	criterion = hyper_params[1]
	max_depth = hyper_params[2]
	min_impurity_decrease = hyper_params[3]
